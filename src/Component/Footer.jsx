        ...
        <footer className="bg-gray-900 text-white">
            <div className="container mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div className="text-center sm:text-left">
                    ...
                    <p className="text-sm mb-1">Email: <span className="text-gray-300">aminurrahman9793@gmail.com</span></p>
                ...
                <div className="text-center">
                    ...
                    <div className="flex justify-center sm:justify-center md:justify-center space-x-4 mt-3">
                        <a href="https://github.com/aminur-tech" target="_blank" rel="noopener noreferrer"
                           className="p-2 rounded-full bg-blue-600 hover:bg-blue-700 transition-colors duration-300">
                            <FaGithub size={24} />
                        </a>
                        <a href="https://x.com/Aminur4078" target="_blank" rel="noopener noreferrer"
                           className="p-2 rounded-full bg-blue-400 hover:bg-blue-500 transition-colors duration-300">
                            <FaTwitter size={24} />
                        </a>
                        <a href="https://www.instagram.com/aminur.rahman_4078/" target="_blank" rel="noopener noreferrer"
                           className="p-2 rounded-full bg-pink-500 hover:bg-pink-600 transition-colors duration-300">
                            <FaInstagram size={24} />
                        </a>
                        <a href="https://www.linkedin.com/in/aminur-rahman4078 " target="_blank" rel="noopener noreferrer"
